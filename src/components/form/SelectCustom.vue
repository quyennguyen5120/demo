<template>
  <div dropdown tabindex="0" ref="rootRef" class="relative custom-select cursor-pointer" @click="toggleDropdown">
    ...
    <div class="w-fit px-2 md:px-0 md:overflow-y-scroll absolute bg-white left-0 right-0 z-40 mt-2 dropdown-list"
...
defineExpose({ rootRef, setDropdown });
</script>
